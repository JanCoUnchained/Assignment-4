...
#for reporting (confidence interval)
brm_meta
value <- c(-0.42, 0.05, -0.51, -0.33)
whatitis <- c("eff_size", "es. error", "lower 95%", "upper 95%")
meta_sum <- data.frame(whatitis, value)
brm_mod
value <- c(-0.40, 0.04, -0.50, -0.31)
mod_sum <- data.frame(whatitis, value)

#conversion (to z-scale)
meta_t <- transfer(meta_sum, "value") #summary stats for meta prior
mod_t <- transfer(mod_sum, "value") #summary stats for own prior 

#based on tidybayes / recoding
